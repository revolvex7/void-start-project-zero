    ...
    <div className="min-h-screen bg-black flex flex-col items-center justify-center px-4 sm:px-6 py-8">
      <div className="w-full max-w-md mx-auto">
        ...
        <div className="text-center mb-10">
          <div className="mx-auto w-12 h-12 bg-white rounded-full flex items-center justify-center mb-6">
          ...
          <h1 className="text-xl sm:text-2xl font-semibold text-white">Log in or sign up</h1>
        </div>
        ...
        <div className="space-y-3 sm:space-y-4">
          ...
          <Button 
            variant="outline" 
            className="w-full bg-white text-gray-900 border-gray-300 hover:bg-gray-50 py-2 sm:py-3 h-auto flex items-center justify-start px-3 sm:px-4 rounded-lg shadow-sm text-sm sm:text-base"
          >
          ...
          <Button 
            variant="outline" 
            className="w-full bg-white text-gray-900 border-gray-300 hover:bg-gray-50 py-2 sm:py-3 h-auto flex items-center justify-center px-3 sm:px-4 rounded-lg shadow-sm text-sm sm:text-base"
          >
